...
@section('content')
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/main_image.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>BECOME FLUENT IN ANY LANGUAGE <a href="#" target="_blank">Get started now</a></h2>
							<p><a class="btn btn-primary btn-lg btn-learn" href="#">Take A Course</a> <a class="btn btn-primary btn-lg popup-youtube btn-video" href="https://www.youtube.com/watch?v=n4NVPg2kHv4"><i class="icon-play"></i> Watch Video</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-md-pull-8 animate-box">
						<div class="mt">
							<h3>We Want You To Learn Language</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<ul class="list-nav">
							...
							<p><a class="btn btn-primary btn-lg popup-youtube btn-video" href="https://www.youtube.com/watch?v=n4NVPg2kHv4"><i class="icon-play"></i> Watch Video</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#">
						<img src="images/project-1.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<div class="image-teacher">
							<h3>English</h3>
							<span><i class="fa fa-language" aria-hidden="true"></i> 8310 Teachers</span>
						</div>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#">
						<img src="images/project-2.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<div class="image-teacher">
							<h3>English</h3>
							<span><i class="fa fa-language" aria-hidden="true"></i> 8310 Teachers</span>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 text-center animate-box">
					<p><a class="btn btn-primary btn-lg btn-learn" href="#">FIND YOUR TEACHER</a></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row bs-wizard animate-box" style="border-bottom:0;">
				...
				<div class="col-xs-3 bs-wizard-step complete">
					...
					<div class="bs-wizard-info text-center"><p>Sign Up</p></div>
				</div>
				...
				<div class="col-xs-3 bs-wizard-step active"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="bs-wizard-info text-center"><p>Choose a teacher</p></div>
				</div>
				...
				<div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="bs-wizard-info text-center"><p>Choose a date and time</p></div>
				</div>
				...
				<div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="bs-wizard-info text-center"><p>Connect</p></div>
				</div>
			</div>
	...
	<div id="fh5co-started" style="background-image:url(images/img_bg_2.jpg);">
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="#" class="btn btn-default btn-lg">Get started now</a></p>
				</div>
			</div>
		</div>
	</div>
